...
void c_reset(RiverCrossing * env) {
    ...
    fprintf(stderr,"Resetting RiverCrossing environment\n");
    printf("Resetting RiverCrossing environment\n");
    fflush(stdout);
    ...
    fprintf(stderr,"num_entities: %d, num_cols: %d\n", env->num_entities, env->num_cols);
     //clear obs
