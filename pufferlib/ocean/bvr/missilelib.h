...
#define MISSILE_BASE_THRUST_BOOST 400.0f
#define MISSILE_BASE_THRUST_SUSTAIN 125.0f
...
#define MISSILE_BASE_CM_FIN -5.0f

#define MISSILE_BASE_CN_BETA 1.5f
#define MISSILE_BASE_CN_R -6.0f
#define MISSILE_BASE_CN_FIN -5.0f

#define MISSILE_BASE_MAX_VEL 300.0f
#define MISSILE_BASE_MAX_OMEGA 30.0f

#define MISSILE_GUIDANCE_K_YAW 5.0f
#define MISSILE_GUIDANCE_K_PITCH 5.0f
#define MISSILE_GUIDANCE_K_R 0.3f
#define MISSILE_GUIDANCE_K_Q 0.3f
